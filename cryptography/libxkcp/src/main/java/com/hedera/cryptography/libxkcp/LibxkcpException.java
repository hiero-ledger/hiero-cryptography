...
/// An exception thrown when a call to a native libXKCP function fails in regular,
...
/// our own libXKCP native library, so it's available and known to work. Also,
...
public class LibxkcpException extends RuntimeException {
    /// Wraps the Throwable cause.
    public LibxkcpException(Throwable cause) {
        super(cause);
    }
}
