...
/// JNI for HintsLibraryBridge.decompressG1ToEip2537Blst
/// Accepts a 48-byte compressed BLS12-381 G1 point and returns its 128-byte EIP-2537 encoding,
/// or null on error.
#[no_mangle]
pub extern "system" fn Java_com_hedera_cryptography_hints_HintsLibraryBridge_decompressG1ToEip2537BlstImpl(
    env: JNIEnv,
    _instance: JObject,
...
/// JNI for HintsLibraryBridge.decompressG2ToEip2537Blst
/// Accepts a 96-byte compressed BLS12-381 G2 point and returns its 256-byte EIP-2537 encoding,
/// or null on error.
#[no_mangle]
pub extern "system" fn Java_com_hedera_cryptography_hints_HintsLibraryBridge_decompressG2ToEip2537BlstImpl(
    env: JNIEnv,
    _instance: JObject,
    compressed_jarray: JByteArray,
) -> jbyteArray {
